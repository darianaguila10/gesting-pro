...
import 'package:gesting/categoria/selectcategorycard.dart';
...
class SelectGastosCategory extends StatefulWidget {
  SelectGastosCategory({Key key}) : super(key: key);

  @override
  SelectGastosCategoryState createState() => SelectGastosCategoryState();
}

GlobalKey<ScaffoldState> _scalffoldkey = GlobalKey();

class SelectGastosCategoryState extends State<SelectGastosCategory> {

  static const String routeName = "/selectgastcategoria";
                ...
                Expanded(
                  child: FlatButton(
                    ...
                    onPressed: () {
                      ...
                      categoriaProvider.getCategorias("gasto");
                    },
                  ),
                ),
              ],
  ...
  void onDeletedRequest(Categoria categoria) {
    categoriaProvider.deleteCategoria(categoria, "gasto");
  }
  ...
  void createCategory(Categoria nNombre) {
    if (_keyCreateForm.currentState.validate()) {
      ...
      Navigator.of(context).pop();
      nNombre.type = "gasto";
      categoriaProvider.addCategoria(nNombre, "gasto");
    } else {
      setState(() {
        _validateFC = true;
      });
  ...
  void updateCategory(Categoria nNombre) {
    if (_keyUpdateForm.currentState.validate()) {
      ...
      Navigator.of(context).pop();
      categoriaProvider.updateCategoria(nNombre, "gasto");
    } else {
      setState(() {
        _validateFU = true;
      });
