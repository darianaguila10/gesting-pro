          ...
          child: ClipPath(
            ...
            child: Container(
              decoration: BoxDecoration(
                  border: Border(
                      left: BorderSide(
                          color: categoria.color ?? Colors.green, width: 4))),
              child: ListTile(
                trailing: IconButton(
                ...
                leading:
                    getIcons(categoria.icon, categoria.color ?? Colors.green),
                title: Text(
