...
class GastosCategory extends StatefulWidget {
  GastosCategory({Key key}) : super(key: key);

  @override
  _GastosCategoryState createState() => _GastosCategoryState();
}

GlobalKey<ScaffoldState> _scalffoldkey = GlobalKey();

class _GastosCategoryState extends State<GastosCategory> {
