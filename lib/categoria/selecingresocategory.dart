...
class SelectIngresosCategory extends StatefulWidget {
  SelectIngresosCategory({Key key}) : super(key: key);

  @override
  SelectIngresosCategoryState createState() => SelectIngresosCategoryState();
}

GlobalKey<ScaffoldState> _scalffoldkey = GlobalKey();

class SelectIngresosCategoryState extends State<SelectIngresosCategory> {
  static const String routeName = "/selectingcategoria";
